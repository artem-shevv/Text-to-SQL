...
-- Какие у меня есть контакты студентов-старост? Номера телефонов старост групп, где я являюсь куратором группы или групп, которые находятся на направлении подготовки, где куратор курса? Я преподаватель
-- Номера телефонов старост тех групп, которые я курирую. Номера телефонов старост групп, которые находятся на моём курсе? Я преподаватель
WITH 
teacher_id AS (
...
--Кто из студентов не сдал мой предмет? Какие студенты получили 2 по моему предмету экзамену или не сдали мне зачёт? Я преподаватель
WITH 
teacher_id AS (
...
--оказался дубль уже обученного запроса
